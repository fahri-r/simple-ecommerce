...
@section('content')
    ...
    <div class="container py-16">
        <div class="w-10/12 grid grid-cols-1 md:grid-cols-3 gap-6 mx-auto justify-center">
            <div class="border border-primary rounded-sm px-3 py-6 flex justify-center items-center gap-5">
                <img src="{{ asset('assets/images/icons/delivery-van.svg') }}" alt="Delivery"
            ...
            <div class="border border-primary rounded-sm px-3 py-6 flex justify-center items-center gap-5">
                <img src="{{ asset('assets/images/icons/money-back.svg') }}" alt="Delivery"
                    class="w-12 h-12 object-contain">
                <div>
            ...
            <div class="border border-primary rounded-sm px-3 py-6 flex justify-center items-center gap-5">
                <img src="{{ asset('assets/images/icons/service-hours.svg') }}" alt="Delivery"
                    class="w-12 h-12 object-contain">
                <div>
    ...
    <div class="container pb-16">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-6">
            @if (isset($random_products->data))
                @foreach ($random_products->data as $p)
                    <div class="bg-white shadow rounded overflow-hidden group">
                        <div class="relative">
                            <img src="{{ isset($p->image) ? $p->image->url : asset('/assets/images/product-placeholder.png') }}"
                                alt="{{ isset($p->image) ? $p->image->name : 'Product' }}" class="w-full">
